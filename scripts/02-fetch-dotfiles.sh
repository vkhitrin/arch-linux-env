...
[ -d "$HOME/Projects/Automation/Setup/dotfiles" ] || git clone --separate-git-dir="$HOME/Projects/Automation/Setup/dotfiles" http://github.com/vkhitrin/dotfiles /tmp/dotfiles
